...
const logButton = document.querySelector(".logButtonShow");
const searchBox = document.querySelector(".search-box-container");
magnify.addEventListener("click", () => {
  magnify.classList.toggle("hide-icon");
  magnify.classList.toggle("active-pseudo");

  const isSearchBoxOpen = searchBox.classList.toggle(
    "search-box-container-Open"
  );
  logButton.classList.toggle("logButtonHide", isSearchBoxOpen);
  logButton.classList.toggle("logButtonShow", !isSearchBoxOpen);
});
